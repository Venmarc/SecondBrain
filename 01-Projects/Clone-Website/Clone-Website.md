...
**Status (2026-09-21):** Visual polish and layout architecture complete (1440px wrap, feathered hero cell graphic, balanced Origins 2-column layout with 66ch measure, and interactive process timeline component with dynamic SVG Bezier curve and scroll tracer). All 13 static Astro routes verified and merged to `main`. Code: `~/Documents/Codon-Labs`.
