...
| Sand particles | [[09-Particle-Footer]] | Canvas particle figures/text: offscreen `getImageData` targets, 600–2000 grains lerping + jitter; highlight one headline word bright-white; static fallback = SVG grain clip — **working build: `demos/acquire-particle-footer/index.html` (+ `preview.png`)** | Loop = rAF; stop off-screen, respect reduced-motion |
