...
## Batch 2 — living & editorial footers (replication recipes)
...
| Sand particles | [[09-Particle-Footer]] | **v2 antigravity morph-field (working)**: drifting grain field assembles into a real human handshake pair on cursor hover — embedded silhouette mask → sampled shape points → unique 1:1 particle assignment, 3s life cycle, `hoverProgress²` assembly, 25% non-joiners; `demos/acquire-particle-footer/` | rAF + IO pause; reduced-motion → static field |
